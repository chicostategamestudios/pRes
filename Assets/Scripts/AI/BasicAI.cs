/*This script was written by James | Last edited by James | Modified on September 26, 2017
...
public class BasicAI : MonoBehaviour 
{
    ...
    public float dodge_time = 0.5f; //the amount of time it takes to dodge.

    public float cooldown_action = 1f; //how long the AI will take before it performs another action.
    ...
    public float knockback_duration = 0.2f; //how long the AI is staggered for when they are hit.
    ...
    public float stagger_after_knockback_dur = 0.3f; //the duration of a stun after the knockback.
